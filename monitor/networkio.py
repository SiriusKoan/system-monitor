...
def clear_network_io_speed():
    input_total_tmp = network_input_speed_total[-1]
    output_total_tmp = network_output_speed_total[-1]
    ...
    network_input_speed_total.append(input_total_tmp)
    network_output_speed_total.append(output_total_tmp)
    # for interface in interfaces:
    #     network_input_speed_per[interface].append(
    #         psutil.net_io_counters(pernic=True)[interface].bytes_recv
    #     )
